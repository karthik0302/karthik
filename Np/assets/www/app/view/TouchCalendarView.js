 ...
 *
 */
Ext.define('GS.view.TouchCalendarView', {
	...
	initialize: function() {
        ...
        /**
        this.element.on({
        	singletap:this.showEvents,
        	scope:this
        });
        */
        this.element.on({
        	doubletap:this.showNewEvent,
        	scope:this
        });
	...
	showNewEvent:function(){
		 Ext.Viewport.add(Ext.create('GS.view.newEventsView'));
	},
	...
	applyViewMode: function(viewMode){
        ...
        var viewModeFns = GS.view.TouchCalendarView[viewMode.toUpperCase()];
	...
	statics: {
		...
		MONTH: {
				...
				getStartDate: function(date){
					return Ext.bind(GS.view.TouchCalendarView.WEEK.getStartDate, this)(new Date(date.getFullYear(), date.getMonth(), 1));
				},
